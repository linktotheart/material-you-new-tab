<template>
  <div class="relative size-[300px]">
    ...
    >
      <!-- // hour hand -->
      <div
        class="h-20  absolute w-5 -top-[70px] rounded-2xl clock-hands bg-purple-500 origin-bottom transition-all duration-1000"
        :style="`--twrotate: ${hour}deg`"
      ></div>
      <!-- // minute hand -->
      <div
        class="h-[100px]  absolute w-5 -top-[90px] rounded-2xl clock-hands bg-purple-400 origin-bottom transition-all duration-1000"
        :style="`--twrotate: ${minute}deg`"
		>
        <div
          class="w-5 h-6 absolute -bottom-2.5 bg-purple-400 rounded-full m-auto"
        ></div>
      </div>
      <!-- // second hand -->
      <div
      ...
      >
        <div
          class="size-5 absolute -top-[30px] bg-purple-400 rounded-full m-auto"
        ></div>
      </div>
    </div>
  </div>
